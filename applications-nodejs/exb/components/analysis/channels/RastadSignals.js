...
var RastadSignals = RastadSignals || {};
			...
			return ChannelData.Data.map((Content, index) => {
				...
				if (ExchangeType) {
					...
					var StructuredTargets = NewTargets.map((Target) => {
						...
						var TargetPrecision = RastadSignals.Precision(ExchangeType[0], Currency, TargetNumber);
					...
					var StructuredOpenTargets = OpenTargets.map((OpenTarget) => {
						...
						var OpenTargetPrecision = RastadSignals.Precision(ExchangeType[0], Currency, OpenTargetNumber);
					...
					// 		},
					// 		body: {
					// 			ChatID: `rs-${Content.reply_to.reply_to_msg_id}`
					// 		},
					// 		json: true
					// 	},
...
exports.RastadSignals = RastadSignals;
